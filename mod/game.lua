...
function game:Update(dt)
  ...
  elseif self.current_state == "play" then
    play:Update(dt)
...
function game:Draw()
  ...
  elseif self.current_state == "play" then 
    play:Draw()
    love.graphics.print("Vie: "..tostring(player_object.settings.pv), 5, 5)
    love.graphics.print("Temps: "..tostring(math.floor(self.timer)), 200, 5)
...
function game:Reset()
  self.timer = self.chrono
  bullet_object.player = {}
  bullet_object.soldat = {}
  soldat_object.liste = {}
end
